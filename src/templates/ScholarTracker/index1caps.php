...
<body>
  ...
  <section id="hero">
    ...
    <div class="container-fluid">
      ...
      <h2 >Automated Phinma UI Scholar's System for Monitoring</p></h2>
      <h1>SCHOLAR TRACK</h1>
    ...
    <div class="button">
    <a class="btn-group5" href='{{url_for("terminal")}}'> TERMINAL</a>
    </div>
    </div>

      <!-- <a data-aos="fade-up" data-aos-delay="200" href="/capstone/caps/templates/admin.php"  class="btn-get-started1 scrollto">ADMINISTRATION</a> <br>
      </div>
      <a data-aos="fade-up" data-aos-delay="200" href="http://127.0.0.1:5000/Sign in" class="btn-get-started2 scrollto" > OPERATIONS </a>
  
    <a data-aos="fade-up" data-aos-delay="200" href="http://127.0.0.1:5000/Sign in" class="btn-get-started3 scrollto" > SCHOLAR DETAILS </a>
